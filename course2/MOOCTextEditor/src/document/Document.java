...
public abstract class Document {
    ...
    protected int countSyllables(String word)
    {
        ...
        boolean isVowelSeq = false;
        for (int i = 0; i < wordLen ; i++) {
            CharSequence currChar = word.substring(i, i + 1);
            boolean isVowel = "aeiouy".contains(currChar);
            if (isVowel) {
                if (i == wordLen - 1) {
                    if (!isVowelSeq && numOfSyllables != 0 && currChar.equals("e")) {
